...
<div id="xterm_page_wrapper">
    <div class="xterm_page_header">
       <h4>Nuxt Generate</h4> <button class="btn btn-action btn-sm circle open-close"><i class="dashicons dashicons-arrow-up-alt2 "></i></button>
    </div>
...
<script>
    ...
    var AJAX_CMD_READ = "wpnuxt-cmd-generate";
